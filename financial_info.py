...
class DocScraper:
    ...
    def parsing_file(self):
        ...
        # Get Item 1a
        item_1a_raw = document[self.file][pos_dat['start'].loc['item1a']:pos_dat['start'].loc['item1b']]
        item_1a_content = BeautifulSoup(item_1a_raw, 'lxml')
        item_content['item1a'] = item_1a_content.get_text()

        # Get Item 7
        item_7_raw = document[self.file][pos_dat['start'].loc['item7']:pos_dat['start'].loc['item7a']]
        item_7_content = BeautifulSoup(item_7_raw, 'lxml')
        item_content['item7'] = item_7_content.get_text()
        ...
        item_content['item7a'] = item_7a_content.get_text()
